...
class Juego {
    ...
    elegirColor(ev) {
        //this al dar click es el botón que se toca
    ...
    instruccionesJuego() {
        swal('Bienvenido', 'Este juego pondrá a prueba tu memoria, actualmente tiene 10 niveles, en cada uno va incrementando la dificultad, solo tendrás que ir repitiendo la secuencia \n ¡Tú puedes!', 'info')
